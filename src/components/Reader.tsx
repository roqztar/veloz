    ...
    >
      ...
      {focusMode && (
        <div className="fixed bottom-20 sm:bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center gap-3">
          ...
          {/* Mobile exit button - tappable on touch devices */}
          <button
            onClick={handleToggleFocusMode}
            className={`sm:hidden px-6 py-3 rounded-full ${glassClass} ${textColorClass} text-sm font-medium flex items-center gap-2 active:scale-95 transition-transform`}
